...
class PredefinedMealCopierTest {
    ...
    @BeforeEach
    public void init() {
        Ingredient ingredientOne = new Ingredient(1L, "potato", 340, 180, false, false, true, null, null);
        Ingredient ingredientTwo = new Ingredient(2L, "cucumber", 150, 100, true, false, true, null, null);
        Ingredient ingredientThree = new Ingredient(3L, "carrot", 98, 70, true, false, false, 2L, null);
        Ingredient ingredientFour = new Ingredient(4L, "sugar", 315, 14, false, false, false, 2L, null);
        ...
        predefined = new Meal(1, "predefined meal", 420, "chop chop amd put in pot",
                10, new HashSet<>(), ingredientsOneTwoSet, MealCategory.BREAKFAST, PreparationDifficulty.EASY, true, 1L);
