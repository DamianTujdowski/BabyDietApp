...
class ChildServiceTest {
    ...
    @BeforeEach
    public void init() {
        Ingredient ingredientOne = new Ingredient(1L, "potato", 340, 180, false, false, false, null, null);
        Ingredient ingredientTwo = new Ingredient(2L, "cucumber", 150, 100, true, false, false, null, null);
        Ingredient ingredientThree = new Ingredient(3L, "carrot", 98, 70, true, false, false, null, null);
        Ingredient ingredientFour = new Ingredient(4L, "sugar", 315, 14, false, false, false, null, null);
